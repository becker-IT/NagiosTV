<?php
	...
	switch($func) {
        ...
        case "current":
            ...
            $sql = "SELECT * FROM ${g_table_prefix}_servicestatus s INNER JOIN ${g_table_prefix}_objects o ON s.service_object_id=o.object_id ";
        ...
        case "acked":
            ...
            $sql = "SELECT * FROM ${g_table_prefix}_servicestatus s  ";
            $sql .= "INNER JOIN ${g_table_prefix}_objects o ON s.service_object_id=o.object_id ";
            $sql .= "WHERE current_state <> 0 AND ";
	   ...
	   case "history":
	       ...
	       $sql = "SELECT n.*, o.name1, o.name2 FROM ${g_table_prefix}_notifications n ";
	       $sql .= "INNER JOIN ${g_table_prefix}_objects o ON n.object_id=o.object_id ";
